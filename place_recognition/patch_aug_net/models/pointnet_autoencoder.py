...
class PointNetDecoder(nn.Module):
    def __init__(self, embedding_size, output_channels=3, num_points=1024):
        ...
        #self.fc22 = nn.Linear(1024, 2048)  # add by ericxhzou
        #self.fc222 = nn.Linear(2048, 2048)  # add by ericxhzou
        self.bn1 = nn.BatchNorm1d(1024)
        self.bn2 = nn.BatchNorm1d(1024)
        #self.bn22 = nn.BatchNorm1d(2048)  # add by ericxhzou
        #self.bn222 = nn.BatchNorm1d(2048)  # add by ericxhzou
    ...
    def forward(self, x):
        ...
        #x = F.relu(self.bn22(self.fc22(x)))  # add by ericxhzou
        #x = F.relu(self.bn222(self.fc222(x)))  # add by ericxhzou
...
class PointNetAutoencoder(nn.Module):
    def __init__(
        self, embedding_size, input_channels=3, output_channels=3, output_num_points=1024, normalize=True
    ):
        ...
        self.decoder = PointNetDecoder(embedding_size, output_channels, num_points=output_num_points)
